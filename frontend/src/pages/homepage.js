...
//                 <button className="create-folder-btn" onClick={handleAllowCreateFolder}>Create Folder</button>
//                 <input className="file-upload-input" ref={inputRef} type="file" onChange={handleFileUpload} />
//                 <ul className="breadcrumb">
//                     {folderStructure.flatMap((elem, idx) => {
//                         if (elem.name) return <li key={idx} onClick={() => handleBackClick(idx)}>{elem.name}</li>;
//                         else return null;
//                     })}
//                 </ul>
